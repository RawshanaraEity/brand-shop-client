...
const AboutUs = () => {
    ...
    return (
        <div className="text-center " >
           ...
           <div className="grid grid-cols-1 md:grid-cols-2 p-8 md:p-14">
           <div>
              <img className="h-[600px] w-full" src="https://i.ibb.co/3FzRxMH/about-brand.jpg" alt="" />
            </div>
            <div>
            <div className='flex items-center text-center h-full'>
               ...
               <span className="text-red-600 font-bold"> BiteOfTheBrands</span>
                ...
                <p className='my-10 w-2/3 mx-auto text-xl font-medium'>At BiteOfTheBrands we believe that every meal and every sip should be a memorable experience. We invite you to embark on this culinary journey with us, exploring flavors from around the world, and elevating your dining and drinking rituals to new heights.</p>
               </div>
            </div>
            </div>
           </div>
